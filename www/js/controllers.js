...
.controller('TagCountCtrl', function ($rootScope, $scope, $ionicPopover, $timeout, $filter, apWebService) {
    $scope.$on('$ionicView.enter', function (e) {
        ...
        $scope.adjustQty = function (addQ, delay) {
            ...
            $timeout(function () {
                if (holding == true) { $scope.adjustQty(addQ, 200); }
            },delay);
        }
    });
...
.controller('OnHandCtrl', function ($scope, $http, $stateParams, $rootScope, apWebService) {
    $scope.$on('$ionicView.enter', function (e) {
        var orgListSrv = {
            ...
            params: function () {
                var rv = Object.create($rootScope.currentUser);
                //rv.orgParam = { id: 'Deliver-To Organizations', value: '' }
                return rv;
            },
            listMapping: {
                init: function () {
...
.controller('OnHandResaultCtrl', function ($scope, $http, $stateParams, $rootScope) {
    $scope.$on('$ionicView.enter', function (e) {
...
.controller('SearchItem', function ($scope, $http, $stateParams, $rootScope) {
    $scope.$on('$ionicView.enter', function (e) {
